    ...
    SubShader
    {
        ...
        Pass
        {
						...
						)
			{
				...
				float2 uv_Albedo = packedInput.ase_texcoord5.xyz * _Albedo_ST.xy + _Albedo_ST.zw;
				...
				float3 worldRefl9 = reflect( -normalizedWorldViewDir, float3( dot( tanToWorld0, tex2DNode10 ), dot( tanToWorld1, tex2DNode10 ), dot( tanToWorld2, tex2DNode10 ) ) );
				...
				surfaceDescription.Albedo = ( tex2D( _Albedo, uv_Albedo ) * 0.5 ).rgb;
        ...
        Pass
        {
			...
			PackedVaryingsMeshToPS Vert ( AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord.xyz = float3(inputMesh.uv0,0);
			...
			float4 Frag ( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = ( GlobalSurfaceDescription ) 0;
				float2 uv_Albedo = packedInput.ase_texcoord.xyz * _Albedo_ST.xy + _Albedo_ST.zw;
				
				float2 uv_Normals = packedInput.ase_texcoord.xyz.xy * _Normals_ST.xy + _Normals_ST.zw;
				float3 tex2DNode10 = UnpackNormalmapRGorAG( tex2D( _Normals, uv_Normals ), 1.0f );
				...
				float2 uv_Metallic = packedInput.ase_texcoord.xyz.xy * _Metallic_ST.xy + _Metallic_ST.zw;
				float4 tex2DNode13 = tex2D( _Metallic, uv_Metallic );
...
/*ASEBEGIN
Version=16103
1927;117;1641;858;1399.729;409.1467;1.3;True;True
Node;AmplifyShaderEditor.SamplerNode;10;-1252,29;Float;True;Property;_Normals;Normals;1;0;Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldReflectionVector;9;-879,248;Float;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SamplerNode;1;-617,228;Float;True;Property;_Cubemap;Cubemap;2;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Cube;6;0;SAMPLER2D;0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;1;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;14;5;13;4
ASEEND*/
//CHKSM=81D60397BDD95A113EA46379EBD85B7AC6B4FDBC