...
////// Emissive:
                ...
                float4 node_9822 = _Time;
                float node_4515_ang = node_9822.g;
                ...
                float3 node_2360 = (2.0*_Color.rgb);
                float3 emissive = ((sin((node_7157.g*_Speed))*1.0+2.0)*node_3817.rgb*(_Color.a*node_3565.a)*node_2360);
