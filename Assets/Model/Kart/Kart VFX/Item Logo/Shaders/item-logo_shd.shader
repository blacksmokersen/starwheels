    ...
    SubShader
    {
        ...
        Pass
        {
						...
						)
			{
				...
				float2 uv23 = packedInput.interp03.xy * float2( 1,1 ) + float2( 0,0 );
				float cos22 = cos( ( (0.0 + (_Angle - 0.0) * (2.0 - 0.0) / (360.0 - 0.0)) * PI ) );
				float sin22 = sin( ( (0.0 + (_Angle - 0.0) * (2.0 - 0.0) / (360.0 - 0.0)) * PI ) );
				float2 rotator22 = mul( uv23 - float2( 0.5,0.5 ) , float2x2( cos22 , -sin22 , sin22 , cos22 )) + float2( 0.5,0.5 );
				...
				surfaceDescription.AlphaClipThreshold = ( ( tex2D( _BaseTexture, uv_BaseTexture ).a * tex2D( _BaseTexture, uv_BaseTexture ).a * 3.0 ) * ( 1.0 - tex2D( _Alpha, rotator22 ).r ) );
        ...
        Pass
        {
			...
			float4 Frag ( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv23 = packedInput.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float cos22 = cos( ( (0.0 + (_Angle - 0.0) * (2.0 - 0.0) / (360.0 - 0.0)) * PI ) );
				float sin22 = sin( ( (0.0 + (_Angle - 0.0) * (2.0 - 0.0) / (360.0 - 0.0)) * PI ) );
				float2 rotator22 = mul( uv23 - float2( 0.5,0.5 ) , float2x2( cos22 , -sin22 , sin22 , cos22 )) + float2( 0.5,0.5 );
        ...
        Pass
        {
            ...
            HLSLPROGRAM
										...
										)
				{
					...
					outputPackedVaryingsToPS.ase_texcoord3.zw = inputMesh.ase_texcoord1.xy;
					inputMesh.positionOS.xyz +=  float3( 0, 0, 0 ) ;
					inputMesh.normalOS =  inputMesh.normalOS ;
						...
						)
				{
                    ...
                    float2 uv23 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
                    float cos22 = cos( ( (0.0 + (_Angle - 0.0) * (2.0 - 0.0) / (360.0 - 0.0)) * PI ) );
                    float sin22 = sin( ( (0.0 + (_Angle - 0.0) * (2.0 - 0.0) / (360.0 - 0.0)) * PI ) );
                    float2 rotator22 = mul( uv23 - float2( 0.5,0.5 ) , float2x2( cos22 , -sin22 , sin22 , cos22 )) + float2( 0.5,0.5 );
...
/*ASEBEGIN
Version=16103
1927;1;1906;1050;1150.605;-55.80023;1.299908;True;True
Node;AmplifyShaderEditor.RangedFloatNode;26;-1773.251,1483.975;Float;False;Property;_Angle;Angle;7;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;23;-1297.648,1361.876;Float;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RotatorNode;22;-960.448,1471.676;Float;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;11;-1350.965,-218.9077;Float;True;Property;_BaseTexture;Base Texture;3;0;Create;True;0;0;False;0;None;c680aefd071855148a4bdbea24b5b75f;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.SamplerNode;21;-669.4257,1256.567;Float;True;Property;_Alpha;Alpha;6;0;Create;True;0;0;False;0;None;7d19e1bc6aa258c4289f9ac6d923c209;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;28;-234.5199,1305.803;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-375.3573,339.0791;Float;True;Property;_Emissive;Emissive;1;0;Create;True;0;0;False;0;None;9ea019ce03ef1754a88e5f6251ae7bc2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;17;-313.3821,170.9822;Float;False;Property;_EmissiveColor;EmissiveColor;4;0;Create;True;0;0;False;0;0,0,0,0;0.4339622,0.3541295,0.3541295,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;15;-327.308,-420.5968;Float;False;Property;_Color;Color;5;0;Create;True;0;0;False;0;0,0,0,0;0.8867924,0.477441,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-225.7024,867.0942;Float;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;13;-371.6381,535.8516;Float;True;Property;_Metalic;Metalic;0;0;Create;True;0;0;False;0;None;c680aefd071855148a4bdbea24b5b75f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-412.6178,-41.71542;Float;True;Property;_Normal;Normal;2;0;Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=10F39915672865DAEBAE52083D6C9DEE117E9F42