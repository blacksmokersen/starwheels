...
Shader "NewShader/Overcharge Ground"
{
    Properties
    {
		[HDR]_Color("Color", Color) = (0,0,0,0)
		_GroundDistange("Ground Distange", Float) = 0
		_GroundFade("Ground Fade", Float) = 0
    }
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				float4 Frag(PackedVaryingsMeshToPS packedInput) : SV_Target
				{
					...
					float screenDepth37 = LinearEyeDepth( SampleCameraDepth( screenPos.xy/screenPos.w ).r,_ZBufferParams);
					float distanceDepth37 = abs( ( screenDepth37 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _GroundDistange ) );
					float clampResult39 = clamp( ( 1.0 - distanceDepth37 ) , 0.0 , 1.0 );
					
					surfaceDescription.Color =  ( pow( clampResult39 , _GroundFade ) * _Color * _Color.a ).rgb;
					surfaceDescription.Alpha = 1;
					surfaceDescription.AlphaClipThreshold =  0;
...
/*ASEBEGIN
Version=16103
1927;1;1906;1050;975.5739;359.9883;1;True;True
Node;AmplifyShaderEditor.PowerNode;35;-191.167,3.15097;Float;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;36;-393.7891,161.9112;Float;False;Property;_GroundFade;Ground Fade;2;0;Create;True;0;0;False;0;0;20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;5;-191.7,107;Float;False;Property;_Color;Color;0;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.5607715,0,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;4;129.4129,44.80825;Float;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.DepthFade;37;-831.4258,156.9594;Float;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;38;-574.7057,51.44105;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-1051.141,181.9113;Float;False;Property;_GroundDistange;Ground Distange;1;0;Create;True;0;0;False;0;0;1.6;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;39;-374.9857,31.18925;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;270.3011,40.21185;Float;False;True;2;Float;ASEMaterialInspector;0;3;NewShader/Overcharge Ground;dfe2f27ac20b08c469b2f95c236be0c3;0;1;Forward Unlit;5;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;False;False;True;2;False;-1;False;False;True;2;False;-1;True;0;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;0;False;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;True;1;LightMode=ForwardOnly;False;0;;0;0;Standard;0;5;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=73CB1CB9DA15413EF64E4E325039321384605AB9